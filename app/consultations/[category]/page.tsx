...
export default async function CategoryPage({ params }: { params: Promise<{ category: string }> }) {
  ...
  const faqPageKey = content.slug === "individual" ? "consultation-individual" : content.slug === "couples" ? "consultation-couples" : "consultation-teenagers";
