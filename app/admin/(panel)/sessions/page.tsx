...
const statusLabel: Record<AppointmentStatus, string> = { SCHEDULED: "برنامه‌ریزی‌شده", COMPLETED: "انجام‌شده", CANCELED: "لغوشده", NO_SHOW: "عدم حضور", RESCHEDULED: "تغییرزمان‌یافته" };
function statusTone(status: AppointmentStatus) { return status === AppointmentStatus.COMPLETED ? "success" : status === AppointmentStatus.CANCELED || status === AppointmentStatus.NO_SHOW ? "danger" : status === AppointmentStatus.RESCHEDULED ? "warning" : "info"; }
