...
export default async function SessionDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="admin-page-stack"><AdminPageHeader eyebrow="Appointment" title={appointment.product.title} description={appointment.user.profile?.displayName || appointment.user.email} action={<AdminButton href="/admin/sessions" variant="secondary">بازگشت به جلسات</AdminButton>} />
