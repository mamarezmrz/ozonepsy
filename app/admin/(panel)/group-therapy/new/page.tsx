...
export default async function NewGroupTherapyPage() {
  ...
  return <div className="admin-page-stack admin-course-create-page"><AdminPageHeader eyebrow="Group Therapy" title="ایجاد گروه‌درمانی" action={<AdminButton href="/admin/group-therapy" variant="secondary">بازگشت</AdminButton>} /><section className="admin-panel-card admin-course-create-card"><AdminGroupTherapyForm /></section></div>;
}
